...
const VendorUpdateForm = () => {
  ...
  const [vendor_profile_img, setVenderProfile_img] = useState("");
...
//  const newSelacted2 = contact_state;
 ...
 //   if (newSelacted2) {
  ...
  const UpdateVendorDataChange = async () => {
    ...
    // Vendor apis ------------------------   
    if (vendor_img != vendor_profile_img) {
      check_img = 1;
    }
    ...
    const VendorData = await axios.put(
      `${process.env.REACT_APP_BACKEND_URL}/Vendor/updateVendor/${id}`,
      fromData,
      {
        headers: {
          Authorization: `Bearer ${Intoken.accessToken} `,
  ...
  const OwnerUpdatedata = async () => {
    ...
    const OwnerData = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/Vendor/updateOwner/${id}`, fromData1,
      {
        headers: {
          Authorization: `Bearer ${Intoken.accessToken} `,
        },
  ...
  const ContactUpdatedata = async () => {
    ...
    const ContactUpdateData = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/Vendor/updateContact/${id}`, fromData2,
      {
        headers: {
          Authorization: `Bearer ${Intoken.accessToken} `,
        },
  ...
  const PaymentUpdatedata = async () => {
    ...
    const PaymentUpdateData = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/Vendor/updatePayment/${id}`, {
  ...
  useEffect(() => {
    const getVendorById = async () => {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/Vendor/oneVendor/${id}`,
        {
          headers: {
            Authorization: `Bearer ${Intoken.accessToken}`,
          },
      ...
      setVendorID(response.data.getId._id);
      setorg_name(response.data.getId.org_name);
      setGstin(response.data.getId.Gstin);
      setmobile_number(response.data.getId.mobile_number);
      setvender_email(response.data.getId.vender_email);
      setdate_of_start(response.data.getId.date_of_start);
      setregistered(response.data.getId.registered);
      setwebsiteAddress(response.data.getId.websiteAddress);
      setaddress(response.data.getId.address);
      setadd_lat(response.data.getId.add_lat);
      setadd_long(response.data.getId.add_long);
      setcity(response.data.getId.city);
      setstate(response.data.getId.state);
      setstatus(response.data.getId.status);
      setvendor_img(response.data.getId.vendor_img);
      setVenderProfile_img(response.data.getId.vendor_img);
    };
    getVendorById();
  }, [id]);
  ...
  useEffect(() => {
    if (vendor_profile_img) {
      const abc = `${process.env.REACT_APP_BACKEND_URL}/${vendor_profile_img}`;
      // console.log("abcabcabcabc", abc);
      setVendor_img_url(abc);
    }
  }, [vendor_profile_img]);
  ...
  useEffect(() => {
    const getOwnerById = async () => {
      ...
      console.log("getbyidTrek===>>", response);
      setowner_name(response.data.getId.owner_name);
      setowner_aadhar(response.data.getId.owner_aadhar);
      setowner_mobile(response.data.getId.owner_mobile);
      setowner_email(response.data.getId.owner_email);
      setowner_address(response.data.getId.owner_address);
      setowner_city(response.data.getId.owner_city);
      setowner_state(response.data.getId.owner_state);
      setowner_img(response.data.getId.owner_img);
      setOwnerProfile_img(response.data.getId.owner_img);
    };
    getOwnerById();
  }, [id]);
  // console.log("owner_profile_img", owner_img);
  useEffect(() => {
    if (owner_profile_img) {
      const abc = `${process.env.REACT_APP_BACKEND_URL}/${owner_profile_img}`;
      console.log("owner_profile_img", abc);
      setOwner_img_url(abc);
    }
  }, [owner_profile_img]);
  ...
  useEffect(() => {
    const getContactById = async () => {
      ...
      console.log("getbyidTrek===>>", response);
      setcontact_name(response.data.getId.contact_name);
      setcontact_aadhar(response.data.getId.contact_aadhar);
      setcontact_mobile(response.data.getId.contact_mobile);
      setcontact_email(response.data.getId.contact_email);
      setcontact_address(response.data.getId.contact_address);
      setcontact_city(response.data.getId.contact_city);
      setcontact_state(response.data.getId.contact_state);
      setcontact_img(response.data.getId.contact_img);
      setcontactProfile_img(response.data.getId.contact_img);
    };
    getContactById();
  }, [id]);

  useEffect(() => {
    if (contact_profile_img) {
      const abc = `${process.env.REACT_APP_BACKEND_URL}/${contact_profile_img}`;
      // console.log("abcabcabcabc", abc);
      setContact_img_url(abc);
    }
  }, [contact_profile_img]);
  ...
  useEffect(() => {
    const getPaymentById = async () => {
      ...
      console.log("getbyidTrek===>>", response);
      setname_as_per_bank(response.data.getId.name_as_per_bank);
      setbank_name(response.data.getId.bank_name);
      setbank_account_no(response.data.getId.bank_account_no);
      setIfsc_code(response.data.getId.Ifsc_code);
      setupi_Id(response.data.getId.upi_Id);
      setaccount_type(response.data.getId.account_type);
      setPaymentStatus(response.data.getId.paymentstatus);
      setproffered_method(response.data.getId.proffered_method);
    };
    getPaymentById();
  }, [id]);
  ...
  const getPaymentList = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_BACKEND_URL}/Vendor/allPayment`,
      {
        headers: {
          Authorization: `Bearer ${Intoken.accessToken}`,
        },
  ...
  const deleteConfirmed = async () => {
    var deleteVendor = await axios.delete(
      `${process.env.REACT_APP_BACKEND_URL}/Vendor/deleteVendor/${id}`,
      {
        headers: {
    ...
    var deleteOwner = await axios.delete(
      `${process.env.REACT_APP_BACKEND_URL}/Owner/deleteOwner/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    var deleteContact = await axios.delete(
      `${process.env.REACT_APP_BACKEND_URL}/Contact/deleteContact/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    var deletePayment = await axios.delete(
      `${process.env.REACT_APP_BACKEND_URL}/Payment/deletePayment/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const toggleStatus = () => {
    ...
    // setStatus(newStatus);
 handleInputChange("status",newStatus)// Set status to "Inactive"
                  ...
                  >
                    ...
                    <div>
                        ...
                        <div class="col-md-6">
                          <Form.Group>
                            ...
                            {validationErrors.registered && (
                              <div className="text-danger">Please select a registered </div>
                            )}
                          </Form.Group>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                        <Form.Group>
                              <label htmlFor="exampleInputName1" className="l_one">vendor ID</label> 
                              <Form.Control
                               readOnly
                                type="text"
                                className="form-control f_one"
                  ...
                  <div id="tab-4">
                    ...
                    <div>
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <Form.Group>
                            <label htmlFor="bank_account_no" className="l_one">Bank Account Number <span className="text-danger">*</span></label>
                            <Form.Control
                              required
                              type="number"
                              className="form-control f_one"
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <Form.Group>
                            <label htmlFor="bank_name" className="l_one">Bank Name <span className="text-danger">*</span></label>
                            <Form.Control
                              required
                              type="text"
                              className="form-control f_one"
                        ...
                        <div className="col-md-6">
                          <Form.Group>
                            <label htmlFor="Ifsc_code" className="l_one">IFSC Code <span className="text-danger">*</span></label>
                            <Form.Control
                              required
                              type="text"
                              className="form-control f_one"
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <Form.Group>
                            <label htmlFor="upi_Id" className="l_one">UPI ID <span className="text-danger">*</span></label>
                            <Form.Control
                              required
                              type="text"
                              className="form-control f_one"
                      ...
                      <div className="row">
                        <div class="col-md-6">
                          <Form.Group>
                            <label htmlFor="exampleSelectGender" className="l_one">
                              Preffered Method <span className="text-danger">*</span>
                            </label>
                            <select
